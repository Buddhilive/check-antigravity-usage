...
export default function Home() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-lg text-center space-y-8">
          <div>
            <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Antigravity Tracker</h1>
            <p className="text-gray-500">Sign in to view your Gemini Code Assist usage</p>
          </div>
